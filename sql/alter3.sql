...
-- Comments:Update shipping details and export invoice. PDC Reminder module
...
CREATE TABLE IF NOT EXISTS `0_shipping_details` (
  ...
  `first_weight_date` date NOT NULL,
  `second_weight` float NOT NULL,
  `second_weight_date` date NOT NULL,
...
ADD `packing` VARCHAR( 255 ) NOT NULL ,
